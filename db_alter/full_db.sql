...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 17, 2018 at 07:38 AM
...
(1, 'Default', '', 1, '2018-05-15 19:58:42', '2018-05-15 19:58:42');
...
(1, 1, 'da30b600c200024f5d8a4687fe', '::1', '2018-05-17 13:07:03', '2018-05-17 13:07:03');
...
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2018-05-17 07:37:55'),
...
--
-- Table structure for table `customer_affiliate`
--

DROP TABLE IF EXISTS `customer_affiliate`;
...
--
-- Table structure for table `extension_install`
--
...
--
-- Table structure for table `extension_path`
--

DROP TABLE IF EXISTS `extension_path`;
CREATE TABLE IF NOT EXISTS `extension_path` (
...
('253498df8407869c3fa1f2bb92', '{\"user_id\":\"1\",\"user_token\":\"ngiXpslrLjch3fZyAGz8OleLq7aRRcxy\",\"language\":\"en-gb\",\"currency\":\"USD\"}', '2018-05-17 08:02:25'),
('d6611c524ccb19fdb20fc24ce3', '{\"language\":\"en-gb\",\"currency\":\"EUR\",\"user_id\":\"1\",\"user_token\":\"qW6OqrtUW3hcluH4Yb3e6M2Rwh5Dzcvu\"}', '2018-05-16 15:41:07'),
('da30b600c200024f5d8a4687fe', '{\"api_id\":\"1\"}', '2018-05-17 08:01:03');
...
(201, 0, 'config', 'config_email', 'rakesh.geg@gmail.com', 0),
...
(202, 0, 'config', 'config_encryption', '', 0),
...
(1, 1, 'admin', '741e678b35e1a38fd2e6f205e58ffe43bc56b030', '8gjtHmiPa', 'John', 'Doe', 'rakesh.geg@gmail.com', '', '', '::1', 1, '2018-05-15 19:58:42');
