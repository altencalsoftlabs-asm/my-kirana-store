<?php
class KiranacontrollerUserUser extends ControllerUserUser {
	private $error = array();
	...
	protected function getForm() {
		...
		if (isset($this->error['user_type_id'])) {
			$data['error_user_type_id'] = $this->error['user_type_id'];
		} else {
			$data['error_user_type_id'] = '';
		}
		...
		$data['user_types'] = $this->model_kirana_user_type->getUserTypes();
		...
		if (isset($this->request->post['user_type_id'])) {
			$data['user_type_id'] = $this->request->post['user_type_id'];
		} elseif (!empty($user_info)) {
...
if ($this->request->post['user_type_id']=='') {
			$this->error['user_type_id'] = $this->language->get('error_user_type_id');
		}
