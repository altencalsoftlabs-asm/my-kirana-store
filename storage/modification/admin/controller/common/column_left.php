<?php
class KiranacontrollerCommonColumnLeft extends ControllerCommonColumnLeft {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'kirana/bulkupload')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_bulkupload'),
					'href'     => $this->url->link('kirana/bulkupload', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			// kirana ext
			$kiranaapp = array();
			if ($this->user->hasPermission('access', 'kirana/apphistory')) {
				$kiranaapp[] = array(
					'name'	   => $this->language->get('text_approvalhistory'),
					'href'     => $this->url->link('kirana/apphistory', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			if ($kiranaapp) {					
				$data['menus'][] = array(
					'id'       => 'menu-approval',
					'icon'	   => 'fa-puzzle-piece', 
					'name'	   => $this->language->get('text_approval'),
					'href'     => '',
					'children' => $kiranaapp
				);		
			}
			...
			// Kirana options
			$kirana = array();
			if ($this->user->hasPermission('access', 'localisation/pack_type')) {
				$kirana[] = array(
					'name'	   => $this->language->get('text_pack_type'),
					'href'     => $this->url->link('localisation/pack_type', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			if ($this->user->hasPermission('access', 'localisation/product_gender')) {
				$kirana[] = array(
					'name'	   => $this->language->get('text_product_gender'),
					'href'     => $this->url->link('localisation/product_gender', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			if ($this->user->hasPermission('access', 'localisation/kirana_type')) {
				$kirana[] = array(
					'name'	   => $this->language->get('text_kirana_type'),
					'href'     => $this->url->link('localisation/kirana_type', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			if ($this->user->hasPermission('access', 'localisation/kirana_locality')) {
				$kirana[] = array(
					'name'	   => $this->language->get('text_kirana_locality'),
					'href'     => $this->url->link('localisation/kirana_locality', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			if ($kirana) {	
				$localisation[] = array(
					'name'	   => $this->language->get('text_kirana'),
					'href'     => '',
					'children' => $kirana		
				);
			}
